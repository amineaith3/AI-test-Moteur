...
plt.ylabel('Brand')
plt.tight_layout()
plt.savefig('../images/plot_1_top_brands.png')
plt.close()
...
plt.tight_layout()
plt.savefig('../images/plot_2_price_distribution.png')
plt.close()
...
plt.tight_layout()
plt.savefig('../images/plot_3_fuel_types.png')
plt.close()
...
plt.tight_layout()
plt.savefig('../images/plot_4_avg_price_by_brand.png')
plt.close()
